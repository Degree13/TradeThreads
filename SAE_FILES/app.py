...
# middle wear | chaque personne qui se connecte on lui cree une serie de session
# on lui cree une role
@app.before_request
def before_request():
...
# blueprint permet de couper le code en petit bout --> dans le dossier controllers --> auth_security
